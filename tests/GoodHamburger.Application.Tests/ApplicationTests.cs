...
public class CreateOrderCommandHandlerTests
{
    ...
    private readonly IDiscountPolicy _policy = Substitute.For<IDiscountPolicy>();
    ...
    public async Task Handle_ValidCommand_CreatesOrder()
    {
        ...
        _menuRepo.GetByIdsAsync(Arg.Any<IEnumerable<Guid>>(), Arg.Any<CancellationToken>())
            .Returns(menuItems);
        _policy.CalculatePercent(Arg.Any<IReadOnlyCollection<Domain.Entities.OrderItem>>()).Returns(10m);
...
public class UpdateOrderCommandHandlerTests
{
    ...
    public async Task Handle_ExistingOrder_UpdatesAndReturns()
    {
        ...
        _policy.CalculatePercent(Arg.Any<IReadOnlyCollection<Domain.Entities.OrderItem>>()).Returns(0m);
...
public class GetMenuQueryHandlerTests
{
    ...
    public async Task Handle_ReturnsMenuItems()
    {
        ...
        _menuRepo.GetAllAsync(Arg.Any<CancellationToken>()).Returns(items);
